    ...
    <body class="cm-no-transition cm-1-navbar">
                ...
                <div class="cm-flex">
                    <div class="nav-tabs-container">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a>2. Administration / Technique </a></li>
        ...
        <div id="global">
            ...
            <div class="container-fluid">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">ÉTAPE 1 : INFORMATIONS PERSONNELLES</div>
                    <div class="text-danger text-center"><?php if(isset($_GET['message'])){echo $_GET['message'];}?></div>
                    <div class="panel-body" id="demo-buttons">

                        <form class="form-horizontal" action="var/perso.php" method="POST" autocomplete="off">

                        <div class="panel-body">

                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">NOM ET PRENOMS</label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control" id="" name="nom_prenoms">
                                        </div>
                                        <label for="" class="col-sm-1 control-label">CONTACT</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" id="" name="contact">
                                        </div>
                                        <!-- <label for="" class="col-sm-1 control-label">ORIGINE</label>
                                        <div class="col-sm-4">
